...
* Worked on a team in the documentation of the problem analysis and the presented solutions for the possibility of replicating and improving each solution.
* Prototyping and testing of body equipment to improve and adapt the functionality of existing HMI technology.
...
* Developed CAD files for simple robotic models, electronical schematics for simulations, worked on the programming of embedded systems and successfully prototyped multiple projects to verify their viability. <br>
</div>
...
* Worked on industrial automation projects with pneumatics and electropneumatic systems with the objective of reducing the time and cost of a process, simulated the systems using FluidSIM and Factory I/O and implemented some of them saving up to 2 seconds.
* Designed, developed, modified and debugged source code reducing the size allowing the use of cheaper microcontrollers.
* FPGA and CPLD programming experience (VHDL)
* Electronic design (Proteus, OrCAD)
* Digital image and signal processing (MATLAB)
* Computer Vision (with MATLAB and Python)
* CAD/CAE (SolidWorks, Creo Parametric, Hypermesh)
...
* Lots of adaptability using computers and learning new software.
</div>
...
## **Software**
*I know how to use these software*
* Altair Hypermesh
* CIROS Studio
* Factory I/O
* FluidSIM
...
<div data-iframe-width="150" data-iframe-height="270" data-share-badge-id="d702ea86-4a3d-4b2c-87c0-8662b538e190" data-share-badge-host="https://www.credly.com"></div><script type="text/javascript" async src="//cdn.credly.com/assets/utilities/embed.js"></script>

<div data-iframe-width="150" data-iframe-height="270" data-share-badge-id="f7051f9c-b63a-48d4-86ee-80707d1efa51" data-share-badge-host="https://www.credly.com"></div><script type="text/javascript" async src="//cdn.credly.com/assets/utilities/embed.js"></script>

**Badges** on [LinkedIn](https://www.linkedin.com/in/cesarcontreras514)
* C (**Top 5%**)
* Git (**Top 5%**)
* HTML (**Top 5%**)
* JavaScript (**Top 5%**)
* Machine Learning (**Top 5%**)
* MATLAB (**Top 5%**)
* Microsoft Excel (**Top 5%**)
* Python (**Top 5%**)

### **Certifications**
* KNX ETS5 Course (2020) [<i class="fas fa-graduation-cap"></i>](https://wbt5.knx.org/)
* Core Track Universal Robots (2020) [<i class="fas fa-graduation-cap"></i>](https://academy.universal-robots.com/)

### **Courses taken,** *degree related*

* **IELC4304** Digital Circuits II (2020) *by Dr. Eric Zurita Bustamante* [.](https://scholar.google.com.mx/citations?user=QYYkhM8AAAAJ&hl=en)
* **IMEC4305** Industrial Networks (2020) *by Dr. Josué Javier Téllez* [.](https://scholar.google.com.mx/citations?user=7H5WRPkAAAAJ&hl=en)
* **IMEC4304** Inmotics and Domotics (2020) *by Professor Adriana Sandoval Garcia* [.](https://tesis.ipn.mx/handle/123456789/18977 browse?type=author&value=Sandoval+Garc%C3%ADa%2C+Corina+Adriana)
* **IMEC3309** Vibrations Analysis (2020) *by Professor Alejandro Bustamante Contreras* .
* **IMEC4307** Servo positioning Systems (2020) *by Dr. Cesar Alvarez Rocha* .
* **IMEC4308** Industrial Vision Systems (2020) *by Dr. Elizabeth Guevara Martinez* [.](https://www.saber.cic.ipn.mx/SABERv3/Repositorios/webVerArchivo/25956/3)
...
* **EACL0301** Artistic appreciation of cinematography (2020) by Professor Carlos Leon Castillo .
